...
| Price | `100g · ฿N · Yk ₫` segments split on ` / `, rendered as rows with bold weights | same, newline-joined |
...
- **Dual currency (฿ + ₫).** Every price segment shows Thai baht, then Vietnamese đồng: `Xg · ฿N · Yk ₫` (sets, if priced: `฿1165 · 1.5m ₫`). Convert THB at **790 ₫ = ฿1** (mid-market Aug 2026) and round to the nearest 5 ฿. THB always sits before ₫. Recompute THB whenever the ₫ price changes.
